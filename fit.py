...
from numpy import diagonal, exp, array, power, copy
...
class Fit_linear(Fit_curve):
    ...
    def gerar_qui_quadrado(self):
        return super().gerar_qui_quadrado(array([1,1]),self.funcao, self.funcao2)#retorna o qui quadrado da classe Fit_curve com o vetor ajustado para função linear
...
class Fit_exponencial(Fit_curve):
    ...
    def funcao(self,parametros,x):
        return parametros[1]*exp(parametros[0]*x) # retorna B*e^(A*X)
    ...
    def gerar_qui_quadrado(self):
        return super().gerar_qui_quadrado(array([1,1]),self.funcao,self.funcao2)#retorna o qui quadrado da classe Fit_curve com o vetor ajustado para função exponencial
...
class Fit_quadrada(Fit_curve):
    ...
    def funcao(self,parametros,x):
        return parametros[0]*power(x,2) + parametros[1]*x + parametros[2]#retorna A*X² + B*X + C
    ...
    def gerar_qui_quadrado(self):
        return super().gerar_qui_quadrado(array([1,1,1]),self.funcao,self.funcao2)#retorna o qui quadrado da classe Fit_curve com o vetor ajustado para função quadratica
...
class Fit_cubica(Fit_curve):
    ...
    def funcao(self,parametros,x):
        return parametros[0]*power(x,3) + parametros[1]*power(x,2) + parametros[2]*x + parametros[3]#retorna A*X³ + B*X² + C*X + D
    ...
    def gerar_qui_quadrado(self):
        return super().gerar_qui_quadrado(array([1,1,1,1]),self.funcao,self.funcao2)#retorna o qui quadrado da classe Fit_curve com o vetor ajustado para função cúbica
...
class Fit_racional(Fit_curve):
    ...
    def funcao(self,parametros,x):#retorna A/(X+B)
        return parametros[0]*power((parametros[1]+x),-1)
    
    def funcao2(self,x,a,b):#mesma função, parametros trocados. a função odr só aceita o primeiro método e a função fit_curve só aceita os segundo
        return a*power((x+b),-1)
    ...
    def gerar_qui_quadrado(self):
        ...
        if verificar == self.xdata.size:
            return super().gerar_qui_quadrado(array([1,1]),self.funcao,self.funcao2)#retorna o qui quadrado da classe Fit_curve com o vetor ajustado para função racional
            ...
            aux1 = Fit_racional(copy(self.xdata[:verificar]),#aux1 recebe a função antes da mudança de sinal
                                copy(self.ydata[:verificar]),
                                copy(self.x_erro[:verificar]),
                                copy(self.y_erro[:verificar]))
            aux2 = Fit_racional(copy(self.xdata[verificar:]),#aux2 recebe a função depois da mudança de sinal
                                copy(self.ydata[verificar:]),
                                copy(self.x_erro[verificar:]),
                                copy(self.y_erro[verificar:]))
